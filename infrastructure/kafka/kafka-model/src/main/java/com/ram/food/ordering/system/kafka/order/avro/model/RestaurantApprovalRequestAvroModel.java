 ...
 */
package com.ram.food.ordering.system.kafka.order.avro.model;
...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase
    implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3139491132558877413L;

  public static final org.apache.avro.Schema SCHEMA$ =
      new org.apache.avro.Schema.Parser()
          .parse(
              "{\"type\":\"record\",\"name\":\"RestaurantApprovalRequestAvroModel\",\"namespace\":\"com.ram.food.ordering.system.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"sagaId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"restaurantId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"restaurantOrderStatus\",\"type\":{\"type\":\"enum\",\"name\":\"RestaurantOrderStatus\",\"namespace\":\"com.ram.food.ordering.system.kafka.order.avro.model.enums\",\"symbols\":[\"PAID\"]}},{\"name\":\"products\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Product\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}}},{\"name\":\"price\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}}]}");
   ...
   */
  public static BinaryMessageDecoder<RestaurantApprovalRequestAvroModel> createDecoder(
   ...
   *     this class
   */
  public static RestaurantApprovalRequestAvroModel fromByteBuffer(java.nio.ByteBuffer b)
  ...
  private com.ram.food.ordering.system.kafka.order.avro.model.enums.RestaurantOrderStatus
      restaurantOrderStatus;
  private java.util.List<com.ram.food.ordering.system.kafka.order.avro.model.Product> products;
  ...
  public RestaurantApprovalRequestAvroModel(
      ...
      com.ram.food.ordering.system.kafka.order.avro.model.enums.RestaurantOrderStatus
          restaurantOrderStatus,
      java.util.List<com.ram.food.ordering.system.kafka.order.avro.model.Product> products,
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      ...
      case 5:
        products =
            (java.util.List<com.ram.food.ordering.system.kafka.order.avro.model.Product>) value$;
        break;
      case 6:
   ...
   */
  public com.ram.food.ordering.system.kafka.order.avro.model.enums.RestaurantOrderStatus
   ...
   * @param value the value to set.
   */
  public void setRestaurantOrderStatus(
      com.ram.food.ordering.system.kafka.order.avro.model.enums.RestaurantOrderStatus value) {
   ...
   */
  public java.util.List<com.ram.food.ordering.system.kafka.order.avro.model.Product> getProducts() {
    return products;
  }
   ...
   */
  public static com.ram.food.ordering.system.kafka.order.avro.model
          .RestaurantApprovalRequestAvroModel.Builder
      newBuilder() {
    return new com.ram.food.ordering.system.kafka.order.avro.model
        .RestaurantApprovalRequestAvroModel.Builder();
  }
  ...
  public static com.ram.food.ordering.system.kafka.order.avro.model
          .RestaurantApprovalRequestAvroModel.Builder
      newBuilder(
          com.ram.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
                  .Builder
              other) {
    if (other == null) {
      return new com.ram.food.ordering.system.kafka.order.avro.model
      ...
      return new com.ram.food.ordering.system.kafka.order.avro.model
          .RestaurantApprovalRequestAvroModel.Builder(other);
    }
  }
  ...
  public static class Builder
      extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
    ...
    private Builder(
      ...
      if (isValidValue(fields()[4], other.restaurantOrderStatus)) {
        this.restaurantOrderStatus =
            data().deepCopy(fields()[4].schema(), other.restaurantOrderStatus);
     ...
     * @return This builder.
     */
    public com.ram.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
            .Builder
    ...
    public com.ram.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
            .Builder
        setSagaId(java.util.UUID value) {
    ...
    public com.ram.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
            .Builder
        setRestaurantId(java.util.UUID value) {
    ...
    public com.ram.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
            .Builder
        setOrderId(java.util.UUID value) {
     ...
     * @return The value.
     */
    public java.util.List<com.ram.food.ordering.system.kafka.order.avro.model.Product>
        getProducts() {
      return products;
    }
    ...
    public com.ram.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
            .Builder
        setCreatedAt(java.time.Instant value) {
    ...
    public RestaurantApprovalRequestAvroModel build() {
      try {
        ...
        record.restaurantId =
            fieldSetFlags()[2] ? this.restaurantId : (java.util.UUID) defaultValue(fields()[2]);
        record.orderId =
            fieldSetFlags()[3] ? this.orderId : (java.util.UUID) defaultValue(fields()[3]);
        record.restaurantOrderStatus =
            fieldSetFlags()[4]
                ? this.restaurantOrderStatus
                : (com.ram.food.ordering.system.kafka.order.avro.model.enums.RestaurantOrderStatus)
        ...
        record.products =
            fieldSetFlags()[5]
                ? this.products
                : (java.util.List<com.ram.food.ordering.system.kafka.order.avro.model.Product>)
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<RestaurantApprovalRequestAvroModel> WRITER$ =
      (org.apache.avro.io.DatumWriter<RestaurantApprovalRequestAvroModel>)
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<RestaurantApprovalRequestAvroModel> READER$ =
      (org.apache.avro.io.DatumReader<RestaurantApprovalRequestAvroModel>)
  ...
  public int hashCode() {
    ...
    result = 31 * result + (sagaId == null ? 0 : sagaId.hashCode());
    result = 31 * result + (restaurantId == null ? 0 : restaurantId.hashCode());
    result = 31 * result + (orderId == null ? 0 : orderId.hashCode());
    result =
        31 * result
            + (restaurantOrderStatus == null
                ? 0
                : ((java.lang.Enum) restaurantOrderStatus).ordinal());
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RestaurantApprovalRequestAvroModel)) {
      return false;
    }
    RestaurantApprovalRequestAvroModel other = (RestaurantApprovalRequestAvroModel) o;
    if (!java.util.Objects.equals(this.id, other.id)) {
      return false;
    }
    if (!java.util.Objects.equals(this.sagaId, other.sagaId)) {
      return false;
    }
    if (!java.util.Objects.equals(this.restaurantId, other.restaurantId)) {
      return false;
    }
    if (!java.util.Objects.equals(this.orderId, other.orderId)) {
      return false;
    }
    if (!java.util.Objects.equals(this.restaurantOrderStatus, other.restaurantOrderStatus)) {
      return false;
    }
    if (!java.util.Objects.equals(this.products, other.products)) {
      return false;
    }
    if (!java.util.Objects.equals(this.price, other.price)) {
      return false;
    }
