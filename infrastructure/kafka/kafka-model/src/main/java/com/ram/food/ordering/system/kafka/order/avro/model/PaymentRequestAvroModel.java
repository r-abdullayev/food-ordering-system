...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase
  ...
  private com.ram.food.ordering.system.kafka.order.avro.model.enums.PaymentOrderStatus
      paymentOrderStatus;
  ...
  public PaymentRequestAvroModel(
      ...
      com.ram.food.ordering.system.kafka.order.avro.model.enums.PaymentOrderStatus
          paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      ...
      case 6:
        paymentOrderStatus =
            (com.ram.food.ordering.system.kafka.order.avro.model.enums.PaymentOrderStatus) value$;
        break;
      default:
        throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
   ...
   */
  public com.ram.food.ordering.system.kafka.order.avro.model.enums.PaymentOrderStatus
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(
      com.ram.food.ordering.system.kafka.order.avro.model.enums.PaymentOrderStatus value) {
   ...
   */
  public static com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder
      newBuilder() {
    return new com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel
        .Builder();
  }
  ...
  public static com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder
      newBuilder(
          com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder
              other) {
    if (other == null) {
      return new com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel
          .Builder();
  ...
  public static com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder
      newBuilder(
          com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel other) {
    if (other == null) {
      return new com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel
          .Builder();
    } else {
  ...
  public static class Builder
     ...
     */
    private Builder(
        com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @return This builder.
     */
    public com.ram.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder
  ...
  public int hashCode() {
    ...
    result =
        31 * result
            + (paymentOrderStatus == null ? 0 : ((java.lang.Enum) paymentOrderStatus).ordinal());
    return result;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PaymentRequestAvroModel)) {
      return false;
    }
    PaymentRequestAvroModel other = (PaymentRequestAvroModel) o;
    ...
    if (!java.util.Objects.equals(this.paymentOrderStatus, other.paymentOrderStatus)) {
      return false;
    }
    return true;
  }
